...
! function(t, e) {
    ...
    function Xe(t) {
        ...
        return ct ? (t in Ye || (ze(e = be(n, document.createElement("div")), "uk-" + t), Ye[t] = Ue(e, "content", ":before").replace(/^["'](.*)["']$/, "$1"), $e(e)), Ye[t]) : qe(n).getPropertyValue("--uk-" + t)
    }
    var Ge = {};
        ...
        return void 0 === s && (s = 200), ae.all(V(t).map(function(o) {
            return new ae(function(n, i) {
                ...
                Jt(o, "animationend animationcanceled", function(t) {
                    ...
                    self: !0
                }), Re(o, "animationDuration", s + "ms"), ze(o, e, tn + (h ? "leave" : "enter")), w(e, tn) && ze(o, a && "uk-transform-origin-" + a, h && tn + "reverse")
            })
        }))
    }
    ...
    function sn(t, e, c, l, d, n, i, r) {
        ...
        return gn(m, c, p, -1), gn(m, l, g, 1), d = vn(d, p.width, p.height), n = vn(n, g.width, g.height), d.x += n.x, d.y += n.y, m.left += d.x, m.top += d.y, i && (o = [hn(R(t))], r && o.unshift(hn(r)), K(on, function(t, s) {
            ...
            !0 !== i && !b(i, a) || o.some(function(i) {
                ...
                function o(e, t) {
                    var n = F((m[h] + e + t - 2 * d[a]).toFixed(4));
                    if (n >= i[h] && n + p[s] <= i[u]) return m[h] = n, ["element", "target"].forEach(function(t) {
    ...
    function bn(t, e, n) {
        return void 0 === e && (e = "width"), void 0 === n && (n = window), P(t) ? +t : u(t, "vh") ? xn(ln(R(n)), t) : u(t, "vw") ? xn(dn(R(n)), t) : u(t, "%") ? xn(hn(n)[e], t) : F(t)
    }
    ...
    function di(e, n, i) {
        ...
        }) : !r || u && !u.call(e) || e._events.push(Xt(r, t, h ? z(h) ? h : h.call(e) : null, z(o) ? e[o] : o.bind(e), {
            passive: a,
            capture: s,
            self: c
        }))
    ...
    ti.util = Object.freeze({
            ...
            scrollParents: Xn,
            getViewport: Gn
        }), ti.data = "__uikit__", ti.prefix = "uk-", ti.options = {}, ti.version = "3.5.8", ii = (ei = ti).data, ei.use = function(t) {
                ...
                props: function(g, m) {
                    ...
                    return so.reduce(function(t, e) {
                        ...
                        if (r ? (a = m.style.color, s = s.map(function(t) {
                            ...
                            }), m.style.color = a) : w(e, "bg") ? (h = "bgy" === e ? "height" : "width", s = s.map(function(t) {
                                return bn(t, h, v.$el)
                            }), Re(m, "background-position-" + e[2], ""), i = Re(m, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1], n = v.covers ? (u = Math.min.apply(Math, s), c = Math.max.apply(Math, s), l = s.indexOf(u) < s.indexOf(c), d = c - u, s = s.map(function(t) {
                                return t - (l ? u : c)
                        ...
                        switch (e) {
                            ...
                            case "borderColor":
                                ...
                                t[e] = "rgba(" + h.map(function(t, e) {
                                    return t += c * (u[e] - t), 3 === e ? F(t) : parseInt(t, 10)
                                }).join(",") + ")";
                                break;
                            case "blur":
                ...
                Transitioner: function(o, s, a, t) {
                    ...
                    return {
                        ...
                        show: function(t, e, n) {
                            ...
                            }, t, i).then(c.resolve, et), c.promise
                        },
                        stop: function() {
                            return Qe.stop(u)
                        },
                        ...
                        forward: function(t, e) {
                            return void 0 === e && (e = this.percent()), Qe.cancel(u), this.show(t, e, !0)
                        },
                        translate: function(t) {
                            var e = this.getDistance() * a * (lt ? -1 : 1);
                            Re(u, "transform", Yr(tt(e - e * t - l, -po(u), an(u).width) * (lt ? -1 : 1), "px")), this.updateTranslates(), o && (t = tt(t, -1, 1), mo(this.getItemIn(), "itemtranslatein", {
                                percent: t,
                                dir: a
                        ...
                        percent: function() {
                            return Math.abs((Re(u, "transform").split(",")[4] * (lt ? -1 : 1) + n) / (l - n))
                        },
                        getDistance: function() {
                            return Math.abs(l - n)
                        },
                        ...
                        getActives: function() {
                            var n = lo(o || s, u, e);
                            return Z(vo(u).filter(function(t) {
                                var e = go(t, u);
                                return n <= e && e + an(t).width <= an(u).width + n
                            }), "offsetLeft")
                        },
