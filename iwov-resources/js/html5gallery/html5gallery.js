        ...
        k = x.drag = {
            ...
            handler: function(b) {
                ...
                switch (b.type) {
                    ...
                    case "mouseup":
                        u.remove(document, "mousemove mouseup", k.handler), e.dragging && (!1 !== e.drop && x.drop && x.drop.handler(b, e), k.hijack(b, "dragend", e)), k.textselect(!0), !1 === e.click && e.dragging && (jQuery.event.triggered = !0, setTimeout(function() {
    ...
    b.fn.html5gallery = function(k) {
        ...
        e.prototype = {
            ...
            init: function(a) {
                ...
                a.options.frve ? a.options.watermarkcode = "<a style='text-decoration:none; opacity: 0!important; pointer-events: none!important;' target='_blank' href='" + a.options.freelink + "' >" : 0 < a.options.watermarklink.length && (a.options.watermarkcode = "<a style='text-decoration:none; display: none;' target='_blank' href='" + a.options.watermarklink +
                    "' >");
            ...
            readTags: function() {
                ...
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function() {
                    ...
                    t.is("a") && (d = t.attr("href"), k = t.data("ogg"), p = t.data("webm"), q = t.data("link"), s = t.data("linktarget"), u = t.data("poster"), isNaN(t.data("width")) || (l = t.data("width")), isNaN(t.data("height")) || (g = t.data("height")), v = t.data("hd"), y = t.data("hdogg"), x = t.data("hdwebm"), A = t.data("lightboxwidth"), z = t.data("lightboxheight"),
                        H = t.data("youtubeapikey"), E = t.data("youtubeplaylistid"), N = t.data("youtubeplaylistmaxresults"), m = t.hasClass("html5gallerylightbox"));
            ...
            createMarkup: function() {
                this.$gallery = jQuery("<div class='html5gallery-container-" + this.id + "'><div class='html5gallery-box-" + this.id + "'><div class='html5gallery-elem-" + this.id + "'></div><div class='html5gallery-title-" + this.id + "'></div><div class='html5gallery-timer-" + this.id +
                    ...
                    this.id + "'></div><div class='html5gallery-car-slider-" + this.id + "'></div></div></div></div>");
            ...
            createEvents: function() {
                ...
                if ("vertical" == this.options.skin || "verticallight" == this.options.skin ||
                    "showcase" == this.options.skin || "verticalwithleft" == this.options.skin || "verticallightwithleft" == this.options.skin) b(".html5gallery-car-list-" + this.id, this.$gallery).on("DOMMouseScroll mousewheel wheel", function(c) {
                    c.preventDefault();
                ...
                "ontouchstart" in
                window && ("vertical" == this.options.skin || "verticallight" == this.options.skin || "showcase" == this.options.skin || "verticalwithleft" == this.options.skin || "verticallightwithleft" == this.options.skin ? b(".html5gallery-car-" + this.id, this.$gallery).touchSwipe({
                    preventWebBrowser: !0,
                    swipeTop: function() {
            ...
            resizeStyleVertical: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    this.options.showcarousel && ("bottom" == this.options.carouselposition ? (this.options.carouselWidth = this.options.width, this.options.carouselHeight = this.options.carouselheight, this.options.carouselLeft = this.options.padding, this.options.carouselTop = this.options.height + this.options.headerHeight + 2 * this.options.padding, this.options.carAreaLength = this.options.carouselHeight, this.options.carouselSlider = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)) < this.elemArray.length,
                            ...
                            this.options.carouselSlider && (this.options.carouselWidth += 20, this.options.width -= 20, this.options.height = Math.round(this.options.width * this.options.originalHeight / this.options.originalWidth), this.options.boxWidth = this.options.width, this.options.boxHeight = this.options.height + this.options.headerHeight, this.options.carouselHeight = this.options.height + this.options.headerHeight, this.options.totalHeight = this.options.height + this.options.headerHeight + 2 * this.options.padding, this.options.containerHeight = this.options.totalHeight,
                                this.options.slideshadow && (this.options.boxWidth += 8), this.container.css({
                                    height: this.options.containerHeight
                                })), "left" == this.options.carouselposition ? (this.options.boxLeft = this.options.padding + this.options.carouselWidth + this.options.carouselmargin, this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin, this.options.carouselTop = this.options.padding), b(".html5gallery-car-mask-" + this.id).css({
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        e = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight, e = Math.min(a / d, e / c), e = 1 < e ? 1 : e, d = Math.round(e * d), c = Math.round(e * c), this.adjustFullscreen(d, c, !0)) : (d = this.options.width, c = this.options.height), b(".html5gallery-elem-" + this.id).css({
                        width: d + "px",
                        height: c + "px"
                        ...
                        width: d + "px",
                        height: c + "px"
                    }), b("#html5gallery-elem-video-" + this.id).attr("width", d), b("#html5gallery-elem-video-" + this.id).attr("height", c), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", d), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", c), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", d), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height",
                        c), b(".html5gallery-elem-iframe-" + this.id).css({
                        width: d + "px",
                        height: c + "px"
                    ...
                    this.options.showcarousel && (b(".html5gallery-car-" + this.id).css({
                        ...
                        }), (this.options.isMobile || this.isTouch && this.options.splitvsliderontouch) && b(".html5gallery-car-right-" +
                            this.id).css({
            ...
            createStyleVertical: function() {
                ...
                var d = " .html5gallery-container-" + this.id + " { display:block; position:absolute; left:0px; top:0px; width:" + this.options.totalWidth +
                ...
                var d = d + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" + this.options.boxLeft + "px; top:" + this.options.boxTop +
                    ...
                    d = d + (" .html5gallery-viral-" + this.id + " {display:block; overflow:hidden; position:absolute; text-align:left; top:" + c + "px; left:0px; width:" + this.options.boxWidth + "px; height:" + this.options.socialheight +
                        "px; padding-top:" + e + "px;}"),
                    ...
                    d = d + (" .html5gallery-timer-" + this.id +
                ...
                this.options.isIE7 || this.options.isIE6 ? (d += " .html5gallery-loading-" + this.id + " {display:none; }", d +=
                ...
                0 < this.options.borderradius &&
                    (d += " .html5gallery-elem-" + this.id + " { overflow:hidden; border-radius:" + this.options.borderradius + "px; -moz-border-radius:" + this.options.borderradius + "px; -webkit-border-radius:" + this.options.borderradius + "px;}");
                ...
                this.options.showcarousel ? (d += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; width:" + this.options.carouselWidth + "px; height:" + this.options.carouselHeight + "px; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; }", d += " .html5gallery-car-list-" + this.id + " { position:absolute; display:block; overflow:hidden; top:" + this.options.carTop + "px; height:" + String(this.options.carAreaLength) + "px; left:0px; width:" + this.options.carouselWidth + "px; }", d +=
                    ...
                    " {display:none;}", this.options.thumbshowtitle ? (d += " .html5gallery-tn-title-" + this.id + " {display:block; overflow:hidden; float:left; margin-top:0px; margin-left:" + this.options.thumbmargin + "px; width:" + c + "px;height:" + String(this.options.thumbheight - 2) + "px;" + (this.options.thumbshowdescription ? "" : "line-height:" + String(this.options.thumbheight - 2) + "px;") + "}", d += " .html5gallery-tn-title-" + this.id + this.options.thumbtitlecss, d += " .html5gallery-tn-description-" + this.id + this.options.thumbdescriptioncss) : (d +=
                        " .html5gallery-tn-title-" + this.id + " {display:none;}", d += " .html5gallery-tn-description-" + this.id + " {display:none;}"), this.carouselHighlight = function(a) {
            ...
            resizeStyleDefault: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        width: e + "px",
                        height: a + "px"
                    }), b("#html5gallery-elem-video-" + this.id).attr("width", e), b("#html5gallery-elem-video-" + this.id).attr("height", a), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", e), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", a), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width",
                        e), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", a), b(".html5gallery-elem-iframe-" + this.id).css({
                        width: e + "px",
                        height: a + "px"
                    ...
                    if (this.options.showcarousel) {
                        ...
                        b(".html5gallery-car-left-" + this.id).css({
                            display: this.options.carouselNavButton ? "block" :
                                "none"
                        });
                        b(".html5gallery-car-right-" + this.id).css({
            ...
            loadCarousel: function() {
                ...
                for (var d = 0; d < this.elemArray.length; d++) {
                    ...
                    e.hover(function() {
                        ...
                        b(this).data("index") !==
                            a.curElem && b(this).removeClass("html5gallery-tn-selected-" + a.id).addClass("html5gallery-tn-" + a.id)
                    });
                    e = new Image;
                    e.data = d;
                    b(e).on("load", function() {
                        ...
                        a.options.thumblinkintitle && (e = b(".html5gallery-tn-img-" +
            ...
            slideRun: function(a,
                ...
                this.isFullscreen ? (this.$fullscreen.addClass("html5gallery-fullscreen-activeslide-" + this.id + "-" + this.curElem),
                    0 <= this.prevElem && this.$fullscreen.removeClass("html5gallery-fullscreen-activeslide-" + this.id + "-" + this.prevElem)) : (this.$gallery.addClass("html5gallery-activeslide-" + this.id + "-" + this.curElem), 0 <= this.prevElem && this.$gallery.removeClass("html5gallery-activeslide-" + this.id + "-" + this.prevElem));
                ...
                this.options.socialurlforeach && this.createSocialMedia();
                !this.isFullscreen && this.options.showcarousel && (b("#html5gallery-tn-" + this.id + "-" + this.curElem, this.$gallery).removeClass("html5gallery-tn-" + this.id).addClass("html5gallery-tn-selected-" +
                ...
                if (this.options.showtitle || this.options.lightboxshowtitle || this.options.lightboxshowdescription) {
                    ...
                    if (this.isFullscreen) {
                        ...
                        this.options.lightboxshowdescription &&
                            f && (j += "<div class='html5gallery-fullscreen-description-" + this.id + "'>" + f + "</div>");
                    ...
                    (!this.options.titleoverlay || !this.options.titleautohide) && b(".html5gallery-title-" +
                ...
                if (!(0 > a)) {
                    ...
                    !this.options.donotuseposter && (5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) && !d && this.elemArray[this.curElem][12] ? (this.showingPoster = !0, this.showPoster()) : (b(".html5gallery-video-play-" + this.id, l).length && b(".html5gallery-video-play-" + this.id, l).remove(),
                        1 == a ? this.showImage() : (this.options.hidetitlewhenvideoisplaying && b(".html5gallery-title-" + this.id, l).hide(), 5 == a || 6 == a || 7 == a || 8 == a ? this.showVideo(d, e) : 9 == a ? this.showYoutube(d) : 10 == a ? this.showVimeo(d) : 11 == a ? this.showEmbedVideo(d) : 2 == a ? this.showSWF() : 12 == a && this.showIframe()));
                    this.checkMK();
                    ...
                    if ((1 == a || this.showingPoster) && !this.isPaused && 1 < this.elemArray.length && (!this.options.loop || this.looptimes < this.options.loop)) e = this.elemArray[this.curElem][16] ?
                        this.elemArray[this.curElem][16] : this.options.slideshowinterval, this.firstrun && this.options.setfirstslideshowinterval && (e = this.options.firstslideshowinterval), this.slideshowTimeout.setInterval(e), this.slideshowTimeout.start(), this.isFullscreen ? b(".html5gallery-fullscreen-timer-" + this.id, this.$fullscreen).css({
                            width: 0
                        }) : b(".html5gallery-timer-" + this.id, this.$gallery).css({
                            width: 0
                        });
            ...
            embedHTML5Video: function(a, c, d, e, f, j, l, g) {
                ...
                !this.options.nativehtml5controls && !this.options.videohidecontrols && (b("video", a).data("src", e), b("video", a).data("hd", f), b("video", a).data("ishd", this.isHd), b("video", a).addHTML5VideoControls(this.options.skinfolder,
                    this, "#html5gallery-elem-html5-video-" + this.id, !1, !1, this.options.defaultvideovolume, this.options.fullscreennativecontrols, this.options.html5videonodownload, null, this.elemArray[this.curElem][ELEM_VTT] ? !0 : !1, this.options.vttline, this.options.showsubtitlebydefault));
...
(function() {
    for (var v = document.getElementsByTagName("script"), s = "", q = 0; q < v.length; q++) v[q].src && v[q].src.match(/html5gallery\.js/i) && (s = v[q].src.substr(0, v[q].src.lastIndexOf("/") + 1));
    v = !1;
